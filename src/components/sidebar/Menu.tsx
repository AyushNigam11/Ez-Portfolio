...
const Menu: FC<MenuProps> = ({}) => {
  ...
  return (
    ...
    >
      ...
      <List
        target="_blank"
        link="https://www.instagram.com/who_is_ayuxh/"
        effect="slideUp"
      >
        <Instagram color="#b5179e" /> Instagram
      </List>
      <List target="_blank" link="https://github.com/AyushNigam11" effect="slideUp">
        <Github color="#2a9d8f" /> Github
      </List>
      <List
        target="_blank"
        link="https://stackoverflow.com/users/20331641/ayush__nigam"
        effect="slideUp"
      >
      ...
      <List
        target="_blank"
        link="https://www.linkedin.com/in/ayush-nigam-2663a5221/"
        effect="slideUp"
      >
